...
function Rules() {
  ...
  return (
    <div> 
        <p className='cursor-pointer font-bold text-lg ' onClick={onOpen}>Rules</p>
        ...
        <ModalContent position={"relative"} backgroundColor="transparent">
            ...
            <ul className='list-disc z-10 px-10 pb-4 text-lg font-semibold space-y-3 text-white'>
                ...
                <li> If the card is defusing card, then the card is removed from the deck.
                    This card can be used to defuse one bomb that may come in subsequent
                    cards drawn from the deck.</li>
